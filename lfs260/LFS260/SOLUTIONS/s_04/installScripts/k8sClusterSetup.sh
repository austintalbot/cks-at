...
ssh -oStrictHostKeyChecking=no -i $1 student@$2 "wget https://cm.lf.training/LFS460/LFS460_V1.21_SOLUTIONS.tar.xz --user=LFtraining --password=Penguin2014"
...
ssh -oStrictHostKeyChecking=no -i $1 student@$3 "wget https://cm.lf.training/LFS460/LFS460_V1.21_SOLUTIONS.tar.xz --user=LFtraining --password=Penguin2014"
